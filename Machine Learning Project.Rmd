...
Part 7: Run a general boosting model (GBM).
...
Part 8: Compare the model accuracy across the 3 models (decision tree, random forest, general boosting)
...
We see that the Random Forest model has highest accuracy. We then predict the test set of 20 observations using the Random Forest model to get the following predicted results:
